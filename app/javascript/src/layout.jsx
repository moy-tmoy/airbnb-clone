          ...
          <div className="container">
            ...
            <div className="row no-gutters justify-content-between py-4 footerBar">
              <div className="col-12 col-xl-auto order-2 order-xl-1">
                  ...
                  <span className="d-block">© 2022 Airbnb, Full Stack Web Application Clone by <a href="https://confident-murdock-8e5bba.netlify.app/" target="_blank" rel='noreferrer noopener'>Francis Artemio Landia</a></span>
                    <ul className="privacyTermsSitemap list-unstyled d-inline-flex align-items-center p-0 m-0">
              ...
              <div className="col-12 col-xl-auto order-1 order-xl-2">
                <div className="text-left text-md-center">
                  <a href="#" className="text-body m-1"><FontAwesomeIcon icon={faTwitter} size="lg" className="ml-2" /></a>
                  <a href="#" className="text-body m-1"><FontAwesomeIcon icon={faInstagram} size="lg" className="ml-2" /></a>
                  <a href="#" className="text-body m-1"><FontAwesomeIcon icon={faLinkedin} size="lg" className="ml-2" /></a>
                  <a href="#" className="text-body m-1"><FontAwesomeIcon icon={faFacebook} size="lg" className="ml-2" /></a>
                </div>
              </div>
            </div>
          </div>
